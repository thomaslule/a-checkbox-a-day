...
import fr.lule.acad.item.ItemController.AddItemCommand;
import fr.lule.acad.item.ItemController.GetMonthItemsCommand;
import fr.lule.acad.item.ItemController.IdCommand;
...
public class ItemControllerShould {
	...
	public void before() {
		...
		list = new ItemListProjection(itemEventStore.getAllEvents());
		bus.register(list);
